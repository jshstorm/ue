...
public:
	...
	virtual FSlateColor GetRowTextColor(FName RowName) const;
...
protected:
	...
	virtual TSharedRef<SAnuRowEditor> CreateRowEditor(UDataTable* Table);
	...
	virtual void ExtendToolbar(TSharedPtr<FExtender> Extender);
	virtual void FillToolbar(FToolBarBuilder& ToolbarBuilder);

	virtual void OnDuplicateRow(const FName NewName){}
	virtual void OnRenameOrDeleteRow(const FName NewName){}
